      ...
      <div className="row">
        ...
        <div id="modal-01" className="popup-modal mfp-hide">
          ...
          <div className="description-box">
            ...
            <span className="categories">
              <i className="fa fa-tag"></i>Branding, Webdesign
            </span>
          </div>
        ...
        <div id="modal-02" className="popup-modal mfp-hide">
          ...
          <div className="description-box">
            ...
            <span className="categories">
              <i className="fa fa-tag"></i>Branding, Web Development
            </span>
          </div>
        ...
        <div id="modal-03" className="popup-modal mfp-hide">
          ...
          <div className="description-box">
            ...
            <span className="categories">
              <i className="fa fa-tag"></i>Branding
            </span>
          </div>
        ...
        <div id="modal-04" className="popup-modal mfp-hide">
          ...
          <div className="description-box">
            ...
            <span className="categories">
              <i className="fa fa-tag"></i>Photography
            </span>
          </div>
        ...
        <div id="modal-07" className="popup-modal mfp-hide">
          ...
          <div className="description-box">
            ...
            <span className="categories">
              <i className="fa fa-tag"></i>Branding, Illustration
            </span>
          </div>
        ...
        <div id="modal-08" className="popup-modal mfp-hide">
          ...
          <div className="description-box">
            ...
            <span className="categories">
              <i className="fa fa-tag"></i>Webdesign, Photography
            </span>
          </div>
